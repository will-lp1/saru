  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background text-foreground flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="mt-12 pb-24 bg-background">
          <div className="container mx-auto px-6 md:px-8 lg:px-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <Card className="h-full flex flex-col rounded-xl">
                <CardHeader className="p-6 text-base font-medium h-16 flex items-center">Repository Growth</CardHeader>
              ...
              <Card className="h-full flex flex-col rounded-xl">
                <CardHeader className="p-6 text-base font-medium h-16 flex items-center">Weekly Activity</CardHeader>
